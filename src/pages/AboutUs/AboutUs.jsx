...
const AboutUs = () => {
   return (
      <div>
               ...
               <div>
                  <div className='flex justify-between items-center mb-4'>
                     ...
                     <div className='flex md:flex-col justify-center items-start'>
                        <h5 className='text-2xl font-medium'>Find Agency</h5>
                  ...
                  <div className='flex justify-between items-center mb-4'>
                     ...
                     <div className='flex md:flex-col justify-center items-start'>
                        <h5 className='text-2xl font-medium'>Find Dream House</h5>
                        <p>Find your real estate agency for your dream house.We are always ready for our
                           clients.
                        </p>
                     </div>
                  ...
                  <div className='flex justify-between items-center'>
                     ...
                     <div className='flex md:flex-col justify-center items-start'>
                        <h5 className='text-2xl font-medium'>Take Keys</h5>
                        <p>Find your real estate agency for your dream house.We are always ready for our
                           clients.
                        </p>
                     </div>
         ...
         <div className='text-center my-6'>
            <h2 className="text-4xl font-bold">Our Agents</h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6'>
               <div className='flex flex-col justify-center items-center bg-red-300 p-8 rounded-xl'>
                  <img src={staffimg1} alt="" className='lg:w-12 lg:h-12 rounded-full'/> 
                  <h4 className='text-xl font-semibold my-2'>Md. Sazzad Hossain</h4>
                  <p className='font-bold'>Founder</p>
               </div>
               <div className='flex flex-col justify-center items-center bg-red-300 p-8 rounded-xl'>
                  <img src={staffimg2} alt="" className='lg:w-12 lg:h-12 rounded-full'/>
                  <h4 className='text-xl font-semibold my-2'>Humayra Jannat</h4>
                  <p className='font-bold'>SEO</p>
               </div>
               <div className='flex flex-col justify-center items-center bg-red-300 p-8 rounded-xl'>
                  <img src={staffimg3} alt="" className='lg:w-12 lg:h-12 rounded-full'/>
                  <h4 className='text-xl font-semibold my-2'>Md. Mamun</h4>
                  <p className='font-bold'>Manager</p>
               </div>
               <div className='flex flex-col justify-center items-center bg-red-300 p-8 rounded-xl'>
                  <img src={staffimg4} alt="" className='lg:w-12 lg:h-12 rounded-full'/>
                  <h4 className='text-xl font-semibold my-2'>Sadia Khan</h4>
